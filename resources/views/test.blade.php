                ...
                <div class="full-width">
                    ...
                    <div class="destinations">
                        <div class="row">
                            <!--column-->
                            <article class="one-fourth">
                                <figure><a href="location.html" title=""><img src="images/uploads/paris.jpg" alt="" /></a></figure>
                                <div class="details">
                            ...
                            <!--column-->
                            <article class="one-fourth">
                                <figure><a href="location.html" title=""><img src="images/uploads/amsterdam.jpg" alt="" /></a></figure>
                                <div class="details">
                                    <a href="location.html" title="View all" class="gradient-button">View all</a>
                                    <h4>Amsterdam</h4>
                            ...
                            <!--column-->
                            <article class="one-fourth">
                                <figure><a href="location.html" title=""><img src="images/uploads/saint-petersburg.jpg" alt="" /></a></figure>
                                <div class="details">
                                    <a href="location.html" title="View all" class="gradient-button">View all</a>
                                    <h4>St Petersburg</h4>
                            ...
                            <!--column-->
                            <article class="one-fourth">
                                <figure><a href="location.html" title=""><img src="images/uploads/prague.jpg" alt="" /></a></figure>
                                <div class="details">
                                    <a href="location.html" title="View all" class="gradient-button">View all</a>
                                    <h4>Prague</h4>
                            ...
                            <article class="one-fourth promo">
                                ...
                                <figure><a href="hot_deals.html" title=""><img src="images/uploads/paris.jpg" alt="" /></a></figure>
                                <div class="details">
                    ...
                    <div class="boxes">
                        ...
                        <article class="one-fourth">
                            <div>
                                ...
                                <p>Book Your Travel reservation system is secure and your credit card and personal information is encrypted.We work to high standards and guarantee your privacy. </p>
                            </div>
                        </article>
                        <!--//column-->
                        ...
                        <article class="one-fourth">
                            <div>
                                <h4>Any Questions?</h4>
                                <p>Call us on <em>1-555-555-555</em> for individual, tailored advice for your perfect stay or <a href="contact.html" title="Contact">send us a message</a> with your hotel booking query.</p>
                            </div>
                        </article>
                        <!--//column-->
                    </div>
